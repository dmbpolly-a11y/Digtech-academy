...
import { CertificateReviewRow } from '@/app/principal/certificates/CertificateReviewRow';
...
export default async function AdminCertificatesPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8 md:px-8">
      ...
      <p className="mt-1 text-sm text-ink/60">Full certificate control — same review queue Principals see.</p>
      ...
      <div className="mt-3 space-y-2">
        ...
        {others.length === 0 && <p className="text-sm text-ink/40">No history yet.</p>}
      </div>
    </div>
  );
}
